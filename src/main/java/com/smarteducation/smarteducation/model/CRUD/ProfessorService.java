...
public class ProfessorService {
    ...
    public List<Materias> materiaInativa(String id){
        Professor prof = this.professorRepository.findByid(id);
        return this.materiaRepository.ativeFindByProfessor(prof.getNome(), false);
    }
    ...
    public List<Alunos> buscarAlunosMateria(String id){
        ...
        materia.getAlunos().forEach(aluno -> {
            Alunos alune = this.alunosRepository.findBymatricula(aluno.getMatricula());
    ...
    public List<Alunos> historicoMateria(String idMateria){
        Materias materia = this.materiaRepository.findByid(idMateria);
        List<Alunos> historico = new ArrayList<>();
        materia.getAlunos().forEach(aluno -> {
            Alunos alune = this.alunosRepository.findBymatricula(aluno.getMatricula());
            historico.add(alune);
        });
